var leaderboard_ad_unit = '<script type="text/javascript"><!--' + "\n" + 
'google_ad_client = "ca-pub-3186126083216536";' + "\n" + 
'/* iPadDrumLessons */' + "\n" + 
'google_ad_slot = "9018760692";' + "\n" + 
'google_ad_width = 728;' + "\n" + 
'google_ad_height = 90;' + "\n" + 
'//-->' + "\n" + 
'</script>' + "\n" + 
...
Ext.ux.UniversalUI = Ext.extend(Ext.Panel, {
    ...
    items: [{
        cls: 'launchscreen',
        html: '<div>Check out these free iPad drum lessons. These are some of the best videos to get you started.</div>' + leaderboard_ad_unit
    }],
    backText: 'Back',
